...
def rotate_ball():
    ...
    return (velocity[0], velocity[1], direcrion)
...
while game: # главный цикл
    ...
    if player_1.y > player_1_y_prev:
        print("еду вниз")
    elif player_1.y < player_1_y_prev:
        print("еду вверх")
    ...
    if ball.colliderect(player_1) or ball.colliderect(player_2):
        ...
        if player_1_y_prev > player_1.y:
            velocity = degrees_to_velocity(ball_direction + 15, 10)
            ball_speed_x = velocity[0]
        if player_1_y_prev < player_1.x:
            velocity = degrees_to_velocity(ball_direction - 15, 10)
            ball_speed_x = velocity[0]
